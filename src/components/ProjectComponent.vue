<template>
  <div class="projects-container">
    <div class="projects">
      <div class="projects__item">
        <div class="projects__info">
          ...
          <div class="projects__description">
            ...
            <a class="projects__link" href="https://reqres.in/" target="_blank"
              >Reqres</a
            >
            and store it. Load more users by page and view detailed information
            on separate pages without the need for page refresh.
          </div>
          <div class="projects__technologies">
            <span class="projects__technology">Vue</span>
            <span class="projects__technology">Vue Router</span>
            <span class="projects__technology">Pinia</span>
          </div>
        ...
        <div class="projects__info">
          ...
          <div class="projects__description">
            ...
            <a
              ...
              >FontAwesome</a
            >
            with a 3 sec delay, each click is handled.
          </div>
          <div class="projects__technologies">
            <span class="projects__technology">Angular</span>
            <span class="projects__technology">Libraries</span>
          </div>
          <div class="projects__links">
            <a
      ...
      <div class="projects__item">
        <div class="projects__info">
          <div class="projects__title">Quiz App</div>
          <div class="projects__description">
            Renders questions, answer options (for single-choice &
            multiple-choice) and calculates the result upon completion based on
            the given data in JSON.
          </div>
          <div class="projects__technologies">
            <span class="projects__technology">Vue</span>
            <span class="projects__technology">SCSS</span>
          </div>
          <div class="projects__links">
            <a
              href="https://github.com/dniils/quiz"
              class="projects__link"
              target="_blank"
              >code</a
            >
      ...
      <div class="projects__item">
        <div class="projects__info">
          ...
          <div class="projects__technologies">
            <span class="projects__technology">HTML</span>
            <span class="projects__technology">SCSS</span>
            <span class="projects__technology">BEM</span>
            <span class="projects__technology">JavaScript</span>
          </div>
          <div class="projects__links">
            <a
      ...
      <div class="projects__item">
        <div class="projects__info">
          ...
          <div class="projects__links">
            <a
              href="https://github.com/dniils/interactive-card-details-form-main"
              class="projects__link"
              target="_blank"
              >code</a
            >
            <a
              href="https://dniils.github.io/interactive-card-details-form-main/"
              class="projects__link"
              target="_blank"
              >demo</a
            >
      ...
      <div class="projects__item">
        <div class="projects__info">
          ...
          <div class="projects__description">
            ...
            <a href="https://rs.school/" class="projects__link" target="_blank"
              >RollingScopes</a
            >
            school.
          </div>
          <div class="projects__technologies">
            <span class="projects__technology">HTML</span>
            <span class="projects__technology">CSS</span>
            <span class="projects__technology">BEM</span>
          </div>
          <div class="projects__links">
            <a
